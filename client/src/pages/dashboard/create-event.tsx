...
export default function CreateEventPage() {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      orgId: "", // Will be set after fetching org
      title: "",
      description: "",
      imageUrl: "",
      eventType: "in-person",
  ...
  // Fetch current user to get their organization ID
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      if (orgId) {
        queryClient.invalidateQueries({ queryKey: ["/api/events", orgId] });
      }
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., Summer Fellowship Gathering" {...field} data-testid="input-title" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="e.g., Community Center, 123 Main St" {...field} data-testid="input-location" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="https://..." {...field} value={field.value || ""} data-testid="input-livestream" />
                      </FormControl>
