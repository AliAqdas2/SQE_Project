...
export default function CreateActivityPage() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto space-y-6">
      <div>
        <h1 className="text-2xl md:text-3xl font-bold">Create Activity</h1>
        <p className="text-sm md:text-base text-muted-foreground">Set up a new class or course</p>
      </div>
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      <FormLabel className="text-base">Free Activity</FormLabel>
                      <FormDescription>
                        This activity is free to join
                      </FormDescription>
                    </div>
                    <FormControl>
                      <Switch
